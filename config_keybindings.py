...
APPS = [
    ...
    ([MOD], "space", 'dmenu_run -c -bw 2 -l 20 -g 4 -sb #FA8072 -shf #FFFFFF -shb #FA8072 -m 2'),
    ...
    #Power off
    ([MOD, ALT], "p", 'systemctl poweroff'),
    #Reboot
    ([MOD, ALT], "r", 'systemctl reboot'),

    #Import keyboard layout and second monitor settings
    ([MOD, ALT], "i", "~/autostart.sh"),
